...
const AiGenerationModal: React.FC<AiGenerationModalProps> = ({
  ...
  const handleNumberOfProblemsChange = (newNumber: number) => {
    ...
    // Update description if we have a suggestion selected
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Description Section with Browse Suggestions */}
        <div style={{ marginBottom: '20px' }}>
          ...
          {/* Visual Connector - shown when suggestions are expanded */}
          {showBrowseSuggestions && (
            <div style={{
              display: 'flex',
              justifyContent: 'center',
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M12 5L12 19M12 19L7 14M12 19L17 14" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          )}
          ...
          {isAutoGenerated && !manuallyEdited && (
            <p style={{
              ...
              ✓ Suggestion added. Edit as needed.
            </p>
          )}
        </div>
